...
from social.views import CommentsListCreateView, LikeCreateView, LikeCheckAPIView, PostDetailView, PostListCreateView, UserPostListView 

urlpatterns = [
    path('posts/',PostListCreateView.as_view(),name="posts"),
    path('posts/<int:pk>/',UserPostListView.as_view(),name="user_posts"),
